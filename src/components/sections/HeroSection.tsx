export default function HeroSection() {
  return (
    <section className="relative flex h-[812px] w-full items-center justify-center overflow-hidden bg-[#FFD900] md:h-[1080px]">
      ...
      {/* Content */}
      <div className="relative z-10 flex w-full flex-col items-center gap-4 px-4 xl:px-[360px] text-center text-[#111] md:gap-[30px]">
        <p className="text-[18px] leading-normal md:text-[30px] md:leading-[36px]">
          At the best exchange rate at the moment you want
        </p>
        <h1 className="text-[40px] font-extrabold leading-[1.2] md:text-[60px] lg:text-[70px] xl:text-[80px] md:leading-[1.3]">
          BEST RATE,
          <br />
          FASTER EXCHANGE
        </h1>
