export default function ProductSection() {
  ...
  return (
    <section className="w-full bg-[#111] py-8 md:py-[100px]">
      <div className="flex w-full flex-col items-center gap-6 px-4 xl:px-[360px] md:gap-10">
        {/* Title */}
        <div className="flex flex-col items-center gap-3 text-center md:gap-[30px]">
          <h2 className="text-[24px] font-bold leading-[1.3] text-white md:text-[32px] lg:text-[40px] md:leading-[1.4] lg:leading-[60px]">
            Before you travel, stop by Dozn Exchange!
          </h2>
          <p className="max-w-[679px] text-[14px] leading-[1.4] text-white/70 md:text-[18px] lg:text-[20px] md:leading-[1.5] lg:leading-[40px]">
